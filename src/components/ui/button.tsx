  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 rounded-xl shadow-warm hover:shadow-medium",
        ghost: "hover:bg-muted hover:text-foreground rounded-xl",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-gradient-hero text-primary-foreground rounded-2xl shadow-glow hover:shadow-medium hover:-translate-y-1 hover:scale-[1.02] font-semibold",
        warm: "bg-gradient-warm text-primary-foreground rounded-2xl shadow-warm hover:shadow-medium hover:-translate-y-1 hover:scale-[1.02] font-semibold",
      },
      size: {
